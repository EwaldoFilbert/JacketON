		    ...
		    <div class="span3">
		    	...
		    	<div class="tabbable"> <!-- Only required for left/right tabs -->
				  <ul class="nav nav-tabs">
				  	<li class="active"><a href="#tab1" data-toggle="tab">Color Options</a></li>				    
				    <li><a href="#tab2" data-toggle="tab">Custom</a></li>
				  </ul>
				  <div class="tab-content">
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div class="well">
							...
							<div id="avatarlist">
								<img style="cursor:pointer;" class="img-polaroid" src="img/16.jpg">
		    ...
		    <div class="span6">		    
				...
				<!--	EDITOR      -->					
					<div id="shirtDiv" class="page" style="width: 530px; height: 630px; position: relative; background-color: rgb(255, 255, 255);">
						<img id="tshirtFacing" src="img/mens_hoodie_front.png" alt="...">
...
<!--						<img src="img/mens_hoodie_back.png"></img>-->
<!--						<div id="drawingArea" style="position: absolute;top: 100px;left: 160px;z-index: 10;width: 200px;height: 400px;">					-->
